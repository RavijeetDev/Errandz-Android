...
public class TaskerSavedJobListFragment extends Fragment implements TaskerJobListAdapter.JobListItemCLickListener {
    ...
    private TaskerSavedJobListViewModel taskerSavedJobListViewModel;
    ...
    private void initializeViewModel() {
        taskerSavedJobListViewModel = ViewModelProviders.of(this).get(TaskerSavedJobListViewModel.class);
        taskerSavedJobListViewModel.init();
        progressBarLayout.setVisibility(View.VISIBLE);

        taskerSavedJobListViewModel.getSavedJobListMutableLiveData().observe(this, jobList -> {
    ...
    public void onResume() {
        super.onResume();
        taskerSavedJobListViewModel.makeTaskerSavedJobApiCall();
    }
}
