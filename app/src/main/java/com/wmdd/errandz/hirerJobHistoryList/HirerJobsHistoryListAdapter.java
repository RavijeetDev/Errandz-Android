...
class HirerJobsHistoryListAdapter extends RecyclerView.Adapter<HirerJobsHistoryListAdapter.ViewHolder>{

    private JobHistoryItemCLickListener jobItemCLickListener;
    private ArrayList<Job> jobHistoryList;

    public HirerJobsHistoryListAdapter(JobHistoryItemCLickListener jobItemCLickListener) {
